var J=Object.defineProperty;var V=(e,t,s)=>t in e?J(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var y=(e,t,s)=>(V(e,typeof t!="symbol"?t+"":t,s),s),H=(e,t,s)=>{if(!t.has(e))throw TypeError("Cannot "+s)};var u=(e,t,s)=>(H(e,t,"read from private field"),s?s.call(e):t.get(e)),L=(e,t,s)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,s)},h=(e,t,s,o)=>(H(e,t,"write to private field"),o?o.call(e,s):t.set(e,s),s);import{a as z,l as G}from"./vendor-833ab380.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const Y="modulepreload",X=function(e){return"/team-too-advancedjs-final-work/"+e},O={},N=function(t,s,o){if(!s||s.length===0)return t();const n=document.getElementsByTagName("link");return Promise.all(s.map(i=>{if(i=X(i),i in O)return;O[i]=!0;const r=i.endsWith(".css"),l=r?'[rel="stylesheet"]':"";if(!!o)for(let p=n.length-1;p>=0;p--){const E=n[p];if(E.href===i&&(!r||E.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${l}`))return;const a=document.createElement("link");if(a.rel=r?"stylesheet":Y,r||(a.as="script",a.crossOrigin=""),a.href=i,document.head.appendChild(a),r)return new Promise((p,E)=>{a.addEventListener("load",p),a.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>t()).catch(i=>{const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=i,window.dispatchEvent(r),!r.defaultPrevented)throw i})};var $,f,v,w;const b=class b{constructor({body:t="",header:s="",actions:o="",className:n=null}={}){L(this,$,void 0);L(this,f,void 0);L(this,v,void 0);L(this,w,"modal");y(this,"onHide",null);y(this,"onOpen",null);h(this,$,s),h(this,f,t),h(this,v,o),h(this,w,u(this,w)+(n?` ${n}`:"")),b.count++,this.render()}get id(){return`modal_${b.count}`}render(){const t=`
    ...
    `},detailActionBtnsTemplate:e=>`
      ...
      </button>`,modalContent:e=>{const{gifUrl:t,name:s,rating:o,description:n,isFav:i}=e,r=M(s),l={target:"Target",bodyPart:"Body Part",equipment:"Equipment",popularity:"Popular",burnedCalories:"Burned Calories"},g=Object.keys(l).map(a=>a in e?`<li class="char-item">
              <h4 class="title">${l[a]}</h4>
              <p class="description">${M(e[a])}</p>
  ...
  </li>`,d=new Proxy({page:1,itemsPerPage:window.innerWidth>767?10:8,showPagination:window.innerWidth<1140},{set(e,t,s){return e[t]=s,t==="page"&&q(),!0}}),T=document.querySelector("#exercises-list"),re=()=>Math.ceil(m.favoritesList.length/d.itemsPerPage),ae=new ie("#exercises-pagination",async e=>{d.page=e}),R=()=>{if(window.innerWidth>1140)return m.favoritesList;const e=(d.page-1)*d.itemsPerPage,t=e+d.itemsPerPage;return m.favoritesList.slice(e,t)??[]};function q(){let e=ne();const t=R();t.length?e=t.map(s=>oe(s)).join(""):T.classList.add("empty"),T.innerHTML=e,d.showPagination&&ae.render(d.page,re())}const I=e=>{m.favoritesList=m.favoritesList.filter(s=>s._id!==e);const t=R();d.page>1&&t.length===0&&(d.page-=1),q()};q();T.addEventListener("click",e=>{var t;if("favDel"in e.target.dataset){const{exerciseId:s}=(t=e.target.closest(".exercise-card"))==null?void 0:t.dataset;if(!s)return;I(s)}});const ce=Object.freeze(Object.defineProperty({__proto__:null,removeExercise:I},Symbol.toStringTag,{value:"Module"}));N(()=>Promise.resolve().then(()=>ce),void 0);var A;const U=(A=document.querySelector("body"))==null?void 0:A.classList;U.contains("index")&&N(()=>import("./exercises-6cd9bc68.js"),["assets/exercises-6cd9bc68.js","assets/vendor-833ab380.js","assets/vendor-e5212ee8.css"]);const le=async()=>{const{modal:e}=await te();e.$el.addEventListener("click",t=>{"favDel"in t.target.dataset&&U.contains("favorites")?(I(e.itemID),e.close()):"rating"in t.target.dataset&&e.close()})};le();const B="quote",de=()=>{const e=ue();e?C(e):new j().get("/quote").then(C)},ue=()=>{const e=localStorage.getItem(B);if(!e)return;const{expireDate:t,quote:s,author:o}=JSON.parse(e);return Date.now()>t?localStorage.removeItem(B):{quote:s,author:o}},me=e=>{e&&localStorage.setItem(B,JSON.stringify({...e,expireDate:new Date(new Date().setHours(23,59,59,0)).getTime()}))},C=({quote:e,author:t})=>{e&&(document.querySelector(".quote-main-quote").innerHTML=e,document.querySelector(".quote-main-author").innerHTML=t,me({author:t,quote:e}))};de();const he=document.querySelector(".js-open-menu"),fe=document.querySelector(".js-close-menu"),F=document.querySelector("#mobile-menu"),Q=document.querySelector("[data-menu-backdrop]"),ve=document.querySelectorAll(".menu__nav-link");function ge(){F.classList.add("is-open"),Q.classList.remove("is-hidden"),document.body.classList.add("no-scroll")}function _(){F.classList.remove("is-open"),Q.classList.add("is-hidden"),document.body.classList.remove("no-scroll")}he.addEventListener("click",()=>{ge()});fe.addEventListener("click",()=>{_()});ve.forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("href").substring(1),s=document.getElementById(t);s&&(s.scrollIntoView({behavior:"smooth"}),_())})});const W=window.matchMedia("(min-width: 768px)");function K(e){e.matches&&_()}W.addListener(K);K(W);document.addEventListener("DOMContentLoaded",function(){const e=window.location.pathname,t=document.getElementById("homeButton"),s=document.getElementById("favoritesButton");e.includes("index.html")?(t.classList.add("active"),t.addEventListener("click",P)):e.includes("favorites.html")?(s.classList.add("active"),s.addEventListener("click",P)):(t.classList.add("active"),t.addEventListener("click",P))});const P=e=>{const t=document.getElementById("homeButton"),s=document.getElementById("favoritesButton");e.currentTarget.classList.contains("active")?e.preventDefault():alert("Button clicked!"),e.currentTarget===s&&t.classList.remove("active")};export{ie as P,j as a,se as c};
//# sourceMappingURL=burger-4035ebdb.js.map
