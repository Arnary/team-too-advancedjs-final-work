var z=Object.defineProperty;var V=(e,s,t)=>s in e?z(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t;var y=(e,s,t)=>(V(e,typeof s!="symbol"?s+"":s,t),t),H=(e,s,t)=>{if(!s.has(e))throw TypeError("Cannot "+t)};var u=(e,s,t)=>(H(e,s,"read from private field"),t?t.call(e):s.get(e)),L=(e,s,t)=>{if(s.has(e))throw TypeError("Cannot add the same private member more than once");s instanceof WeakSet?s.add(e):s.set(e,t)},f=(e,s,t,n)=>(H(e,s,"write to private field"),n?n.call(e,t):s.set(e,t),t);import{a as G,l as Y}from"./vendor-833ab380.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const X="modulepreload",Z=function(e){return"/advancedjs-final-work/"+e},_={},N=function(s,t,n){if(!t||t.length===0)return s();const i=document.getElementsByTagName("link");return Promise.all(t.map(o=>{if(o=Z(o),o in _)return;_[o]=!0;const r=o.endsWith(".css"),d=r?'[rel="stylesheet"]':"";if(!!n)for(let p=i.length-1;p>=0;p--){const w=i[p];if(w.href===o&&(!r||w.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${d}`))return;const a=document.createElement("link");if(a.rel=r?"stylesheet":X,r||(a.as="script",a.crossOrigin=""),a.href=o,document.head.appendChild(a),r)return new Promise((p,w)=>{a.addEventListener("load",p),a.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>s()).catch(o=>{const r=new Event("vite:preloadError",{cancelable:!0});if(r.payload=o,window.dispatchEvent(r),!r.defaultPrevented)throw o})};var $,h,v,E;const b=class b{constructor({body:s="",header:t="",actions:n="",className:i=null}={}){L(this,$,void 0);L(this,h,void 0);L(this,v,void 0);L(this,E,"modal");y(this,"onHide",null);y(this,"onOpen",null);f(this,$,t),f(this,h,s),f(this,v,n),f(this,E,u(this,E)+(i?` ${i}`:"")),b.count++,this.render()}get id(){return`modal_${b.count}`}render(){const s=`
    ...
    `},detailActionBtnsTemplate:e=>`
      ...
      </div>`}},se=e=>s=>{if("favAdd"in s.target.dataset||"favDel"in s.target.dataset){e.isFav=!e.isFav;let t=[...m.favoritesList];"favAdd"in s.target.dataset?t.push(e):"favDel"in s.target.dataset&&(t=t.filter(i=>i._id!==e._id)),m.favoritesList=t;const n=c==null?void 0:c.$el.querySelector(".modal-actions");n&&(n.innerHTML=S.detailActionBtnsTemplate(e.isFav))}},ie=async()=>{const e="https://your-energy.b.goit.study/api/exercises/";return c=new te({className:"exercise-detail"}),document.querySelector("#exercises-list").addEventListener("click",async t=>{if(!t.target.dataset.exerciseId)return;const{exerciseId:n}=t.target.dataset;c.itemID=n,c.open();try{const i=await O.get(`${e}${n}`);if(Object.keys(i).length===0)throw new Error;i.isFav=m.favoritesList.findIndex(({_id:r})=>r===n)>-1,c.body=S.modalContent(i),c.actions=S.detailActionBtnsTemplate(i.isFav);const o=se(i);c.$el.addEventListener("click",o),c.onHide=()=>{c.$el.removeEventListener("click",o)}}catch(i){const o=O.describeError(i);console.error(o),c.body=`<div style="color: red">${o}</div>`}}),{modal:c}};function ne(e=""){return e=e.toString(),e.charAt(0).toUpperCase()+e.slice(1)}class oe{constructor(s,t){this.element=document.querySelector(s),this.element.addEventListener("click",n=>{n.target.nodeName==="BUTTON"&&t(parseInt(n.target.dataset.page))})}render(s,t){this.element.innerHTML="",!(t<1)&&(this.element.innerHTML=Y.range(1,t+1).map(n=>`
          <button data-page="${n}" class="pagination-button ${n===s?"active":""}">
          ${n}
          </button>
        `).join(""))}}const re=()=>"It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future.",ae=e=>`
  ...
  </div>`,l=new Proxy({page:1,itemsPerPage:window.innerWidth>767?10:8},{set(e,s,t){return e[s]=t,s==="page"&&q(),!0}}),M=()=>Math.ceil(m.favoritesList.length/l.itemsPerPage),ce=new oe("#exercises-pagination",async e=>{l.page=e}),R={list:document.querySelector("#exercises-list")},U=(e,s,t)=>{const n=(s-1)*t,i=n+t;return e.slice(n,i)??[]};function q(){let e=re();const s=U(m.favoritesList,l.page,l.itemsPerPage);s.length&&(e=s.map(t=>ae(t)).join("")),R.list.innerHTML=e,M()>1&&ce.render(l.page,M())}q();const T=e=>{m.favoritesList=m.favoritesList.filter(t=>t._id!==e);const s=U(m.favoritesList,l.page,l.itemsPerPage);l.page>1&&s.length===0&&(l.page-=1),q()};R.list.addEventListener("click",e=>{var s;if("favDel"in e.target.dataset){const{exerciseId:t}=(s=e.target.closest(".exercise-card"))==null?void 0:s.dataset;if(!t)return;T(t)}});const le=Object.freeze(Object.defineProperty({__proto__:null,removeExercise:T},Symbol.toStringTag,{value:"Module"}));N(()=>Promise.resolve().then(()=>le),void 0);var A;const F=(A=document.querySelector("body"))==null?void 0:A.classList;F.contains("index")&&N(()=>import("./exercises-983a9069.js"),["assets/exercises-983a9069.js","assets/vendor-833ab380.js","assets/vendor-e5212ee8.css"]);const de=async()=>{const{modal:e}=await ie();e.$el.addEventListener("click",s=>{"favDel"in s.target.dataset&&F.contains("favorites")?(T(e.itemID),e.close()):"rating"in s.target.dataset&&e.close()})};de();const P="quote",ue=()=>{const e=me();e?C(e):new j().get("/quote").then(C)},me=()=>{const e=localStorage.getItem(P);if(!e)return;const{expireDate:s,quote:t,author:n}=JSON.parse(e);return Date.now()>s?localStorage.removeItem(P):{quote:t,author:n}},fe=e=>{e&&localStorage.setItem(P,JSON.stringify({...e,expireDate:new Date(new Date().setHours(23,59,59,0)).getTime()}))},C=({quote:e,author:s})=>{e&&(document.querySelector(".quote-main-quote").innerHTML=e,document.querySelector(".quote-main-author").innerHTML=s,fe({author:s,quote:e}))};ue();const he=document.querySelector(".js-open-menu"),ve=document.querySelector(".js-close-menu"),Q=document.querySelector("#mobile-menu"),K=document.querySelector("[data-menu-backdrop]"),ge=document.querySelectorAll(".menu__nav-link");function pe(){Q.classList.add("is-open"),K.classList.remove("is-hidden"),document.body.classList.add("no-scroll")}function I(){Q.classList.remove("is-open"),K.classList.add("is-hidden"),document.body.classList.remove("no-scroll")}he.addEventListener("click",()=>{pe()});ve.addEventListener("click",()=>{I()});ge.forEach(e=>{e.addEventListener("click",()=>{const s=e.getAttribute("href").substring(1),t=document.getElementById(s);t&&(t.scrollIntoView({behavior:"smooth"}),I())})});const J=window.matchMedia("(min-width: 768px)");function W(e){e.matches&&I()}J.addListener(W);W(J);document.addEventListener("DOMContentLoaded",function(){const e=window.location.pathname,s=document.getElementById("homeButton"),t=document.getElementById("favoritesButton");e.includes("index.html")?(s.classList.add("active"),s.addEventListener("click",k)):e.includes("favorites.html")?(t.classList.add("active"),t.addEventListener("click",k)):(s.classList.add("active"),s.addEventListener("click",k))});const k=e=>{const s=document.getElementById("homeButton"),t=document.getElementById("favoritesButton");e.currentTarget.classList.contains("active")?e.preventDefault():alert("Button clicked!"),e.currentTarget===t&&s.classList.remove("active")};export{oe as P,j as a,ne as c};
//# sourceMappingURL=burger-7366a8c4.js.map
